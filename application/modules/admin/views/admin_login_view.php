...
<div class="wrapper1">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4">
				<div style="text-align: center;"><img src="<?php echo base_url('assets/images/logo.jpg'); ?>"></div>
				<div class="formbox">
					<form id="forms" method="post" action="<?php echo base_url('admin/admin_login_form'); ?>">
						<div class="row">
							<div class="col-lg-12">
