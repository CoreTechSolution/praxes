...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('admin_assets/css/admin.css'); ?>">
...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="javascript:void(0)" class="logo">
            ...
            <span class="logo-lg"><b>Praxes Admin</b></span>
		</a>
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								...
								<p><?php echo $this->session->userdata('first_name').' '.$this->session->userdata('last_name'); ?> - Admin</p>
							</li>
							<!-- Menu Footer-->
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?php echo base_url('admin/companies'); ?>"><i class="fa fa-industry" aria-hidden="true"></i> Companies</a></li>
                <li class="treeview">
