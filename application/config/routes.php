...
$route['users/delete-user'] = 'users/delete_user';
$route['users/edit-user'] = 'users/edit_user';
/* For Admin */
$route['admin/add-role'] = 'admin/add_role';
...
$route['admin/edit-role'] = 'admin/edit_role';
